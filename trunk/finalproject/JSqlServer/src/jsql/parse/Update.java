...
public class Update implements Statement {
	 ...
	 *            update), and values are Exp objects (the column values). For
	 *            example, the values may be ZConstant objects (like "Smith") or
	 ...
	 *         and values are Exp objects (Expressions that specify column
	 *         values: for example, ZConstant objects like "Smith").
	 */
	...
	/**
	 * Add one column=value pair to the SET... clause This method also keeps
	 * track of the column order
	 * 
	 * @param col
	 *            The column name
	 * @param val
	...
	/**
	 * Get the SQL expression that specifies a given column's update value. (for
	 * example, a ZConstant object like "Smith").
	 * 
	 * @param col
	 *            The column name.
	 * @return a Exp, like a ZConstant representing a value, or a more complex
	 *         SQL expression.
	 */
	public Exp getColumnUpdate(String col) {
		return (Exp) set_.get(col);
	}

	/**
	 * Get the SQL expression that specifies a given column's update value. (for
	 * example, a ZConstant object like "Smith").<br>
